...
#swig sphinxbase_i
swig -I../sphinxbase/include -I../sphinxbase/swig -java -package com.example.testpocketsphinx.swig -outdir src/com/example/testpocketsphinx/swig -o jni/sphinxbase_wrap.c ../sphinxbase/swig/sphinxbase.i

#swig pocketsphinx_i
swig -I../sphinxbase/swig -I../pocketsphinx/include -I../pocketsphinx/swig -java -package com.example.testpocketsphinx.swig -outdir src/com/example/testpocketsphinx/swig -o jni/pocketsphinx_wrap.c ../pocketsphinx/swig/pocketsphinx.i
